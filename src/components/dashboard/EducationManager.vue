  ...
  <DashboardLayout>
    ...
    <Modal :visible="showForm" :title="editTarget ? 'Editar formação' : 'Adicionar formação'" @close="closeForm">
      ...
      <template #footer>
        ...
        <button type="button" class="btn btn-primary" @click="saveForm" :disabled="formSaving">
    ...
    <div v-else class="db-list">
      <div v-for="item in sortedItems" :key="item.id" class="db-list-item">
...
const emptyForm = () => ({
  type: '', institution: '', title: '', fieldOfStudy: '',
