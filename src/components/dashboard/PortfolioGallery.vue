    ...
    <div class="gallery-grid">
      ...
      >
        ...
        <template v-if="file.fileType === 'IMAGE'">
          ...
          <span v-if="idx === coverIndex" class="gallery-cover-badge" title="Esta imagem será usada como capa do item">CAPA</span>
...
/** Index da primeira IMAGEM na ordem visual — recebe o badge "CAPA". */
const coverIndex = computed(() =>
  allItems.value.findIndex(f => f.fileType === 'IMAGE')
);
