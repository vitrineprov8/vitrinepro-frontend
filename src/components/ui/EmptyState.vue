<template>
  <div class="empty-state">
    ...
    <a v-if="actionLabel && actionHref" :href="actionHref" class="btn btn-primary">{{ actionLabel }}</a>
    <button v-else-if="actionLabel" class="btn btn-primary" @click="$emit('action')">{{ actionLabel }}</button>
  </div>
</template>
